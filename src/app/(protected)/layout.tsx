...
import { AnsaChatbot } from "@/components/ui/AnsaChatbot";
    ...
    return (
        <NotificationProvider>
            <div className="flex min-h-screen bg-[#0B0E14]">
                <Sidebar />
                <main className="flex-1 ml-0 md:ml-20 p-4 pt-20 pb-8 md:p-8 md:pt-24 md:pb-8 overflow-y-auto min-h-screen relative z-10 transition-all duration-300">
                    ...
                    <div className="fixed top-3 right-4 md:top-6 md:right-8 z-[60]">
                        <NotificationBell />
                    </div>
