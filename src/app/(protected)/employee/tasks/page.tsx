...
export default function EmployeeTasksPage() {
    ...
    const refreshTasks = async () => {
        if (user) {
            ...
            try {
                ...
                // Filter by activeGroupId if present, otherwise fetch for all (though usually activeGroupId should be set)
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-bold text-white mb-2">Assigned Objectives</h1>
                <p className="text-gray-400">Detailed list of all your missions.</p>
            </div>

            <GlassCard>
                <div className="space-y-4">
                    {loading ? <p className="text-gray-500">Retrieving data...</p> : tasks.length === 0 ? (
